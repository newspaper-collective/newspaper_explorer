...
async def create_overview_tab(state):
    ...
    if state.selected_source:
        ...
        with (
            ui.row()
            .classes("w-full q-gutter-md q-mb-md justify-center")
            .style("align-items: stretch;")
        ):
            # Source selector card
            with ui.card().props("elevated").classes("flex-1").style(card_style):
                with (
                    ui.card_section()
                    .classes("q-pa-md")
                    .style(
        ...
        # Wrap in a row with q-gutter-md to match the stats row alignment
                                    ...
                                    with ui.row().style(
                                        ...
                                        for img_path in sample_images:
                                            ...
                                            with (
                                                ...
                                                .props("elevated")
                                                .style(
                                                    "border: 1px solid #e0e0e0; border-radius: 4px; flex-shrink: 0; width: 150px"
                                                )
                                            ):
                                                ui.image(
