...
from newspaper_explorer.analysis.layout.detection import LayoutDetector, DOCLAYNET_CLASSES
...
def mock_yolo_model():
    ...
    with patch("newspaper_explorer.analysis.layout.detection.YOLO") as mock_yolo:
...
class TestLayoutDetector:
    ...
    @patch("newspaper_explorer.analysis.layout.detection.YOLO")
